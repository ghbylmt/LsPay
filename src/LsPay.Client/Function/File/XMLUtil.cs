...
namespace LsPay.Client.Function.File
{
    /// <summary>
    /// XML文件读取功能类
    /// </summary>
    public class XmlUtil
    {
        ...
        {
            if (string.IsNullOrEmpty(xmlFilePath) || !System.IO.File.Exists(xmlFilePath))
            {
                return null;
            }
            ...
            {
                throw new System.Exception(string.Format("请确认该XML文件格式正确，路径为：{0}", xmlFilePath));
            }
